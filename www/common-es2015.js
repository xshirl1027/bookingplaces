...
let BookingService = class BookingService {
    ...
    addBooking(placeId, placeTitle, placeImage, firstName, lastName, guestNumber, dateFrom, dateTo) {
        ...
        return this.http
            .post('https://ion-angular-course-4a31b.firebaseio.com/bookings.json', Object.assign({}, newBooking, { id: null }))
    ...
    cancelBooking(bookingId) {
        return this.http
            .delete(`https://ion-angular-course-4a31b.firebaseio.com/bookings/${bookingId}.json`)
    ...
    fetchBookings() {
        return this.http
            .get(`https://ion-angular-course-4a31b.firebaseio.com/bookings.json?${this.authService.userId}.json"`)
...
let PlacesService = class PlacesService {
    ...
    fetchPlaces() {
        return this.http
            .get('https://ion-angular-course-4a31b.firebaseio.com/places.json')
    ...
    getPlace(id) {
        return this.http
            .get(`https://ion-angular-course-4a31b.firebaseio.com/places/${id}.json`)
    ...
    addPlace(title, description, price, dateFrom, dateTo, location) {
        ...
        return this.http
            .post('https://ion-angular-course-4a31b.firebaseio.com/places.json', Object.assign({}, newPlace, { id: null }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(resData => {
            generatedId = resData.name;
            return this.places;
    ...
    deletePlace(placeId) {
        return this.http.delete(`https://ion-angular-course-4a31b.firebaseio.com/places/${placeId}.json`);
    }
    updatePlace(place) {
        let updatedPlaces;
        return this.places.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(places => {
            ...
            return this.http.put(`https://ion-angular-course-4a31b.firebaseio.com/places/${place.id}.json`, Object.assign({}, updatedPlaces[updatedPlaceIndex], { id: null }));
